...
public class PersonaFrmDto {
	...
	public PersonaFrmDto(Integer tipoDocumentoId, String numeroDocumento, String nombres, String apellidos, String apodo, Integer paisId, Integer provinciaId, Integer localidadId, GeneroEnum genero) {
		super();
